@extends('layouts.app')
@section('title', 'Tracking & Reducing')
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
            <h1 style="font-size: 1.5rem; font-weight: bold; color: var(--text-main); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">
                <i data-lucide="leaf" style="color: var(--primary);"></i> Tracking & Reducing
            </h1>
        ...
        <div style="background: white; padding: 2rem; border-radius: 12px; width: 100%; max-width: 450px;" @click.stop>
            ...
            <form method="POST" :action="'/admin/inventaris/' + (activeAction?.id) + '/adjust'" style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <div>
                    ...
                    <textarea name="keterangan" class="search-input" style="width: 100%; min-height: 80px; resize: vertical;" x-model="keterangan" :placeholder="activeAction?.type === 'kurang' ? 'Dibagikan ke warga RT 01...' : (activeAction?.type === 'jual' ? 'Dijual eceran ke pasar...' : 'Produksi kompos minggu ini...')" :required="activeAction?.type !== 'jual'"></textarea>
                </div>
