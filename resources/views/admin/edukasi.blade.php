...
<div class="edu-page animate-fade-in" x-data="edukasiData()">
    ...
    <section class="edu-hero">
        <div class="edu-hero-content">
            ...
            <h1>Edukasi Pekerja</h1>
            <p>Materi pelatihan, video tutorial, dan panduan praktis untuk meningkatkan keterampilan pekerja di bidang pertanian, lingkungan, kesehatan, dan kerajinan.</p>
        </div>
        <div class="edu-hero-actions">
            <button class="edu-btn-white" @click="showForm = !showForm">
                <i data-lucide="plus" style="width: 16px; height: 16px;"></i>
                <span x-text="showForm ? 'Tutup Form' : 'Tambah Materi'"></span>
            </button>
            <button class="edu-btn-ghost" @click="searchTerm = ''; activeCategory = 'Semua'; activeType = 'Semua'">
